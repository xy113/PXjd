<?php if (!defined('IN_DSXCMS')) die('Access Denied!');?><?php include template('weixin_header'); ?><div id="weixin" style="padding:20px 10px;">
   ...
   <div class="rowItem">
       ...
       <div class="inputdiv">
       		<p>
       		<select class="select dist" id="province" name="newexaminee[province]">
            <option value="">请选择</option>
          </select>
          </p>
          <p>
          <select class="select dist" id="city" name="newexaminee[city]">
              <option value="">请选择</option>
          </select>
          </p>
          <p>
          <select class="select dist" id="county" name="newexaminee[county]">
              <option value="">请选择</option>
          </select>
          </p>
          <p>
          <select class="select dist" id="town" name="newexaminee[town]">
              <option value="">请选择</option>
          </select>
          </p>
       </div>
