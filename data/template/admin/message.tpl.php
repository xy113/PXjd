<?php if (!defined('IN_DSXCMS')) die('Access Denied!');?><?php include template('header'); ?><div class="sysmessage">
	<h3 class="<?php echo $type;?>"><?php echo $msg;?></h3>
    <?php if($autoredirect) { ?>
    <div class="tips"><?php echo $lang['auto_redirect'];?></div>
    <?php } else { ?>
    <div class="tips"><?php echo $lang['message_tips'];?></div>
    <?php } ?>
    <div class="links">
        <?php if($links) { ?>
